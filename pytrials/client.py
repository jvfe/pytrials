...
class ClinicalTrials:
    ...
    def get_full_studies(self, search_expr, max_studies=50, timer=5, retries=3):
    ...
    def get_study_fields(self, search_expr, fields, max_studies=50, fmt="csv", timer=5, retries=3):
    ...
    def get_study_count(self, search_expr, timer=5, retries=3):
